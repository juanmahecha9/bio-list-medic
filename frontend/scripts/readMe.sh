...
to run use the command : , it is important to use a console that recognizes linux commands.
...
para ejecutar usa el comando: , es importante usar una consola que reconozca los comandos de linux.
